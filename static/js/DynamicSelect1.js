 ...
 */
class DynamicSelect2 {

    constructor(element, options = {}) {
        let defaults = {
            placeholder: 'Выберите изображение для удаления (оставьте пустым, если не хотите удалять изображения)',
            columns: 1,
            name: '',
            width: '',
            height: '',
...
document.querySelectorAll('[data-dynamic-select]').forEach(select => new DynamicSelect2(select));